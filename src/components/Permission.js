  ...
  return (
    <View>
      <View style={styles.containerLogo}>
        <Image style={styles.logo} source={require('../assets/logovc.png')} />
      </View>
      <Text style={[globalStyles.label, globalStyles.textCenter]}>
        This screen require camera permission to scan QR codes
      </Text>
      {cameraStatus === 'denied' ? (
        <Pressable
        ...
        <Text style={[globalStyles.label, globalStyles.textCenter]}>
          Please go to settings and allow permission to access to the camera
        </Text>
      )}
    </View>
  );
